...
- `frontend/public/world-countries-110m.json` — локальные геоданные карты;
...
Минимальный сценарий проверки: открыть лендинг, выбрать маркер на карте, пройти все шаги анкеты, проверить сохранение профиля и дождаться рекомендаций. На GitHub Pages карта должна загружать файл по пути `/Hail-Mary/world-countries-110m.json`.
