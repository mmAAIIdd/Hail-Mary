...
export const InfoView: React.FC<InfoViewProps> = ({ section, onStartQuestionnaire }) => {
  ...
  return (
    <main className="editorial-page info-page mx-auto w-full max-w-6xl px-5 py-14 sm:px-8 sm:py-20 lg:px-12">
      ...
      {isAbout ? (
        <section className="about-principles mt-12 grid gap-5 border-t border-slate-200 pt-8 sm:grid-cols-3">
          <div>
